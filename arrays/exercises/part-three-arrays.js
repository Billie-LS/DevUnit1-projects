...
console.log(cargoHold.indexOf('instruction manual'));  // 4
console.log(cargoHold.splice(4,1));  // instruction manual
console.log(cargoHold);

//3) Replace the elements at indexes 2 - 4 with the items ‘cat’, ‘fob’, and ‘string cheese’.
console.log(cargoHold.splice(2,3,'cat','fob','string cheese')); // ['parrot','keys','meal packs']
console.log(cargoHold);
